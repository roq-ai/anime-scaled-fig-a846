...
export function StoreListPage(props: StoreListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStores({
        relations: ['user', 'figure_inventory.count', 'sales_analytics.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('figure_inventory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.figure_inventory,
        }
      : null,
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/stores/view/${record.id}`} passHref legacyBehavior>
                <Button
